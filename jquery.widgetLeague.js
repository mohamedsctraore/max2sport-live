...
(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        initialContent: function(leagueDetailsAjaxURL, leagueId, widgetKey, leagueName, leagueLogo, timezone) {
            ...
            $('<a href="#standingsTabC" class="titleWidget nav-tab">Classements</a>').prependTo($(leagueLocation));
            // Construct the Fixtures Tab click
            $('<a href="#fixturesTabC" class="titleWidget nav-tab">Calendriers</a>').prependTo($(leagueLocation));
            // Construct the Results Tab click
            $('<a href="#resultsTabC" class="titleWidget nav-tab nav-tab-active">Resultats</a>').prependTo($(leagueLocation));
                ...
                if (timeForFixtures.length > 0) {
                    ...
                    $.ajax({
                        ...
                        if (res.result) {
                            ...
                            // If server dont send results we populate HTML with "Aucune donnée disponible"
                            var htmlConstructor = '<div class="tablele-container">';
                            htmlConstructor += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 5px;">Aucune donnée disponible</p>';
                            htmlConstructor += '</div>';
                            $('#resultsContentTable').append(htmlConstructor);
                        }
                    }).fail(function(error) {
                ...
                $.each(res.result, function(key, value) {
                    ...
                    if (firstElementInJson == 0) {
                        ...
                        if ($.isEmptyObject(groubedByTeam)) {
                            ...
                            htmlInsideTabsConstructor += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                            htmlInsideTabsConstructor += '<div title="Equipe" class="flex-row teams" role="columnheader">Team</div>';
                            htmlInsideTabsConstructor += '<div title="Matchs Joués" class="flex-row fix-width" role="columnheader">MJ</div>';
                            htmlInsideTabsConstructor += '<div title="Victoires" class="flex-row fix-width" role="columnheader">W</div>';
                            htmlInsideTabsConstructor += '<div title="Nuls" class="flex-row fix-width" role="columnheader">D</div>';
                            htmlInsideTabsConstructor += '<div title="Defaites" class="flex-row fix-width" role="columnheader">L</div>';
                            htmlInsideTabsConstructor += '<div title="Difference de buts" class="flex-row goals" role="columnheader">G</div>';
                            ...
                            htmlInsideTabsConstructor += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 5px;">Aucune donnée disponible</p>';
                            htmlInsideTabsConstructor += '</div>';
                            htmlInsideTabsConstructor += '</div>';
                        }
                        $.each(groubedByTeam, function(keyss, valuess) {
                            ...
                            htmlInsideTabsConstructor += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                            htmlInsideTabsConstructor += '<div title="' + ((!keyss) ? "Equipe" : keyss) + '" class="flex-row teams" role="columnheader"><span class="standingsTeamsSpan">' + ((!keyss) ? "Team" : keyss) + '</span></div>';
                            htmlInsideTabsConstructor += '<div title="Matchs Joués" class="flex-row fix-width" role="columnheader">MP</div>';
                            htmlInsideTabsConstructor += '<div title="Victoires" class="flex-row fix-width" role="columnheader">V</div>';
                            htmlInsideTabsConstructor += '<div title="Nuls" class="flex-row fix-width" role="columnheader">N</div>';
                            htmlInsideTabsConstructor += '<div title="Defaites" class="flex-row fix-width" role="columnheader">D</div>';
                            htmlInsideTabsConstructor += '<div title="Difference de buts" class="flex-row goals" role="columnheader">G</div>';
                            htmlInsideTabsConstructor += '<div title="Points" class="flex-row fix-width" role="columnheader">Pts</div>';
                            htmlInsideTabsConstructor += '</div>';
                            htmlInsideTabsConstructor += '<div class="table__body">';
