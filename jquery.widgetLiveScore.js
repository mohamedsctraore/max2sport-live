...
(function($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        initialContent: function(liveScoreDetailsAjaxURL, method, widgetKey, timezone) {
            ...
            // Construct the En direct Tab click
            $('<a href="#liveGame" class="titleWidget nav-tab">En direct</a>').prependTo($(liveScoreLocation));
            // Construct the Tous les matchs Tab click
            $('<a href="#allGame" class="titleWidget nav-tab nav-tab-active">Tous les matchs</a>').prependTo($(liveScoreLocation));
            ...
            // Add hook in HTML for Tous les matchs Tab content infos and make it active
            ...
            // Adding callendar with Tous les matchs for 3 days before and after Aujourdhui
            var getTimeZoneForSlowConn = setInterval(function () {
                if (timeForFixtures.length > 0) {
                    ...
                    $('<a href="#" onclick="windowPreventOpening()" id="currentDayCalendar" class="thisDateForSelect callendarDays callendarDaysActive" data-dateclicked="' + timeForFixtures + '">Aujourdhui</a>').prependTo($('#liveScoreCalendarContainer'));
                    ...
                    // When a day is clicked we make it active and populate Tous les matchs tab
                    $('#liveScoreCalendarContainer').find('.thisDateForSelect').unbind('click').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            // Hide loading screen
                            $('.loading').hide();
                            // Construct the section for Tous les matchs in that specific day
                            ...
                            if (res.result) {
                                ...
                                var htmlConstructor = '<div class="tablele-container">';
                                htmlConstructor += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 5px;">Aucune données disponible</p>';
                                htmlConstructor += '</div>';
                                $('#allGameContentTable').append(htmlConstructor);
                            }
                    ...
                    // We send a request to server for Tous les matchs infos
                    $.ajax({
                        url: liveScoreDetailsAjaxURL,
                        cache: false,
                        data: {
            ...
            // Add hook in HTML for En direct Tab content infos
          ...
          function loadLivescore(){
            ...
            $.ajax({
                ...
                // Clear the En direct HTML
                $('#liveGame').html('');
                // Construct the section for En direct
