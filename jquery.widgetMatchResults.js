                    ...
                    var seeWhatMatchDetailsToShow = setInterval(function() {
                        if (timeForFixtures.length > 0) {
                            ...
                            if ((sessionStorage.getItem('fixturesDate') > timeForFixtures) || (res.result[0].event_status == null) || (res.result[0].event_status == '')) {
                                ...
                                htmlConstructor += '<li><span><a href="#matchSummary" class="matchResults-h2 nav-tab nav-tab-active">Résume du match</a></span></li>';
                                ...
                                htmlConstructor += ((res.result[0].league_round.indexOf('finals') != -1) ? '' : '<li><span><a href="#matchStandings" class="matchResults-h2 nav-tab">Classements</a></span></li>');
                                htmlConstructor += '<li><span><a href="#matchTopScorers" class="matchResults-h2 nav-tab">Meilleurs buteurs</a></span></li>';
                                htmlConstructor += '<li><span><a href="#matchOdds" class="matchResults-h2 nav-tab d-none-tab-odds">Côte</a></span></li>';
                                ...
                                htmlConstructor += '<p>Aucune information en direct disponible pour le moement.</p>';
                                htmlConstructor += '</div>';
                                ...
                                $.ajax({
                                    ...
                                    if(!res2.error){
                                        ...
                                        htmlInsideTabsConstructorh2h += '<div title="hh22hh" class="flex-row matchh2hHeader fix-width" role="columnheader">Derniers matchs: ' + res.result[0].event_home_team + '</div>';
                                        ...
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="flex-table header">';
                                        htmlInsideTabsConstructorh2h += '<div title="hh22hh" class="flex-row matchh2hHeader fix-width" role="columnheader">Derniers matchs: ' + res.result[0].event_away_team + '</div>';
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="tablele-container">';
                                        htmlInsideTabsConstructorh2h += '<div class="table__body">';
                                        ...
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="flex-table header">';
                                        htmlInsideTabsConstructorh2h += '<div title="hh22hh" class="flex-row matchh2hHeader fix-width" role="columnheader">Resultats matchs face à face: ' + res.result[0].event_home_team + ' - ' + res.result[0].event_away_team + '</div>';
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="tablele-container">';
                                        htmlInsideTabsConstructorh2h += '<div class="table__body">';
                                        ...
                                        htmlInsideTabsConstructorh2h += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px; text-align:center;">Aucune donnée disponible</p>';
                                        $('#matchh2h .tab-container').append(htmlInsideTabsConstructorh2h);
                                    }
                                });
                                htmlConstructor += '</div>';
                                ...
                                $.ajax({
                                    ...
                                    if (res.result) {
                                        ...
                                        htmlInsideTabsConstructorTS += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Joueur" class="flex-row players" role="columnheader">Joueur</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Equipe" class="flex-row playerTeam fix-width" role="columnheader">Equipe</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Difference du but" class="flex-row goals" role="columnheader">Difference du buts</div>';
                                        ...
                                        htmlInsideTabsConstructorTS += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px; text-align:center;">Aucune donnée disponible</p>';
                                    }
                                        ...
                                        $.each(res.result, function (key, value) {
                                            ...
                                            if (firstElementInJson == 0) {
                                                ...
                                                if ($.isEmptyObject(onlySelectedGroup)) {
                                                    ...
                                                    htmlInsideTabsConstructorS += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Equipe" class="flex-row teams" role="columnheader">Equipe</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Matches Joués" class="flex-row fix-width" role="columnheader">MP</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Victoires" class="flex-row fix-width" role="columnheader">V</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">N</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">D</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Difference de buts" class="flex-row goals" role="columnheader">Buts</div>';
                                                    ...
                                                    htmlInsideTabsConstructorS += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 5px;">Aucune donnée disponible</p>';
                                                    htmlInsideTabsConstructorS += '</div>';
                                                    htmlInsideTabsConstructorS += '</div>';
                                                } else {
                                                    ...
                                                    htmlInsideTabsConstructorS += '<div title="Matchs joués" class="flex-row fix-width" role="columnheader">MJ</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Victoires" class="flex-row fix-width" role="columnheader">V</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">N</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">D</div>';
                                                ...
                                                if ($.isEmptyObject(onlySelectedGroup)) {
                                                    htmlInsideTabsConstructorS += '<div class="flex-table header" role="rowgroup">';
                                                    htmlInsideTabsConstructorS += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Team" class="flex-row teams" role="columnheader">Equipe</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Matchs joués" class="flex-row fix-width" role="columnheader">MP</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Victoires" class="flex-row fix-width" role="columnheader">V</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">N</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">D</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Goals" class="flex-row goals" role="columnheader">G</div>';
                                ...
                                $.ajax({
                                    ...
                                    if(!res.error){
                                        ...
                                        $('#matchOdds .tab-container').addClass('lineForNoData').prepend('<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px; text-align:center;">Aucune donnée disponible</p>');
                                    }
                                });
                                htmlConstructor += '</div>';
                                htmlConstructor += '</section>';
                                    ...
                                    if(!res.error){
                                        if(res.result) {
                                            ...
                                            if (res.result[0]['event_HW'] !== '' || res.result[0]['event_D'] !== '' || res.result[0]['event_AW'] !== '') {
                                                ...
                                                htmlInsideTabsConstructorP += '<div class="flex-table-error row" role="rowgroup"><p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 6px;">Aucune donnée disponible</p></div>';
                                            }
                                            htmlInsideTabsConstructorP += '</div>';
                                            htmlInsideTabsConstructorP += '</div>';
                                        ...
                                        $('#matchPredictions .tab-container').addClass('lineForNoData').prepend('<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px; text-align:center;">Aucune donnée disponible</p>');
                                    }
                                });
                                htmlConstructor += '</div>';
                                htmlConstructor += '</section>';
                                ...
                                $('#matchResultsContentTable').append('<p class="closeWindow">fermer fenêtre</p>');
                                // Added click function to fermer fenêtre
                                ...
                                // Added click function to header fermer fenêtre
                                ...
                                htmlConstructor += '<ul class="nav-tab-wrapper-all-container">';
                                htmlConstructor += '<li><span><a href="#matchSummary" class="matchResults-h2 nav-tab nav-tab-active">Résume du match</a></span></li>';
                                htmlConstructor += '<li><span><a href="#matchStatistics" class="matchResults-h2 nav-tab">Statistiques</a></span></li>';
                                htmlConstructor += '<li><span><a href="#lineups" class="matchResults-h2 nav-tab">Compositions</a></span></li>';
                                htmlConstructor += '<li><span><a href="#matchh2h" class="matchResults-h2 nav-tab">H2H</a></span></li>';
                                // If league_round: contains "finals" then hide Standings Tab
                                htmlConstructor += ((res.result[0].league_round.indexOf('finals') != -1) ? '' : '<li><span><a href="#matchStandings" class="matchResults-h2 nav-tab">Classements</a></span></li>');
                                htmlConstructor += '<li><span><a href="#matchTopScorers" class="matchResults-h2 nav-tab">Meilleurs Buteurs</a></span></li>';
                                ...
                                // Populate Résume du match section
                                htmlConstructor += '<section id="matchSummary" class="tab-content active">';
                                htmlConstructor += '<div class="tab-container">';
                                ...
                                if (nrArray.length == 0) {
                                    htmlConstructor += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px; text-align:center;">Aucune donnée disponible</p>';
                                } else {
                                    var htmlCC = 0;
                                    var htmlCC2 = 0;
                                    var first = true;
                                    $.each(orderedNewArray, function(key, valueSub) {
                                      if (valueSub) {
                                        if (first && key != '1st Half') {
                                                htmlConstructor += '<div class="lineupsTitle">1ere Mi-Temps</div>';
                                ...
                                if ((res.result[0].event_referee != '') || (res.result[0].event_stadium != '')) {
                                    htmlConstructor += '<div>';
                                    htmlConstructor += '<div class="matchExtraInfosTitle">Infos du match</div>';
                                ...
                                htmlConstructor += '<div class="tab-container">';
                                htmlConstructor += '<div class="lineupsTitle">Equipe de départ</div>';
                                ...
                                if ((res.result[0].lineups.home_team.starting_lineups.length == 0) || (res.result[0].lineups.away_team.starting_lineups.length == 0)) {
                                    htmlConstructor += '<p class="" style="border-left: solid 0px transparent; margin-left:auto; margin-right:auto; margin-top: 13px;">Aucune donnée disponible</p>';
                                } else {
                                ...
                                htmlConstructor += '</div>';
                                htmlConstructor += '<div class="lineupsTitle">Entraineurs</div>';
                                htmlConstructor += '<div class="lineupsContainer">';
                                ...
                                $.ajax({
                                    ...
                                    if(!res2.error){
                                        ...
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="flex-table header">';
                                        htmlInsideTabsConstructorh2h += '<div title="hh22hh" class="flex-row matchh2hHeader fix-width" role="columnheader">Confrontation directe: ' + res.result[0].event_home_team + ' - ' + res.result[0].event_away_team + '</div>';
                                        htmlInsideTabsConstructorh2h += '</div>';
                                        htmlInsideTabsConstructorh2h += '<div class="tablele-container">';
                                        htmlInsideTabsConstructorh2h += '<div class="table__body">';
                                        $.each(res2.result.H2H, function(key, value) {
                                ...
                                $.ajax({
                                    ...
                                    if (res.result) {
                                        ...
                                        htmlInsideTabsConstructorTS += '<div class="flex-table header">';
                                        htmlInsideTabsConstructorTS += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Player" class="flex-row players" role="columnheader">Joueur</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Team" class="flex-row playerTeam fix-width" role="columnheader">Team</div>';
                                        htmlInsideTabsConstructorTS += '<div title="Goals" class="flex-row goals" role="columnheader">Buts</div>';
                                        htmlInsideTabsConstructorTS += '</div>';
                                        htmlInsideTabsConstructorTS += '<div class="table__body">';
                                        $.each(res.result, function(key, value) {
                                            htmlInsideTabsConstructorTS += '<div class="flex-table row" role="rowgroup">';
                                        ...
                                        $.each(res.result, function (key, value) {
                                            ...
                                            if (firstElementInJson == 0) {
                                                ...
                                                if ($.isEmptyObject(onlySelectedGroup)) {
                                                    ...
                                                    htmlInsideTabsConstructorS += '<div title="Matchs joués" class="flex-row fix-width" role="columnheader">MP</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Victoires" class="flex-row fix-width" role="columnheader">W</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">D</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">L</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Goals" class="flex-row goals" role="columnheader">G</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Points" class="flex-row fix-width" role="columnheader">Pts</div>';
                                                    htmlInsideTabsConstructorS += '</div>';
                                                    htmlInsideTabsConstructorS += '<div class="table__body">';
                                                ...
                                                if ($.isEmptyObject(onlySelectedGroup)) {
                                                    htmlInsideTabsConstructorS += '<div class="flex-table header" role="rowgroup">';
                                                    htmlInsideTabsConstructorS += '<div title="Classement" class="flex-row first fix-width" role="columnheader">#</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Equipe" class="flex-row teams" role="columnheader">Team</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Matchs joués" class="flex-row fix-width" role="columnheader">MP</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Victoires" class="flex-row fix-width" role="columnheader">W</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">D</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">L</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Difference de buts" class="flex-row goals" role="columnheader">G</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Points" class="flex-row fix-width" role="columnheader">Pts</div>';
                                                    htmlInsideTabsConstructorS += '</div>';
                                                    htmlInsideTabsConstructorS += '<div class="table__body">';
                                                    htmlInsideTabsConstructorS += '<div class="flex-table-error row" role="rowgroup">';
                                                    ...
                                                    htmlInsideTabsConstructorS += '<div title="Nuls" class="flex-row fix-width" role="columnheader">D</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Defaites" class="flex-row fix-width" role="columnheader">L</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Difference de but" class="flex-row goals" role="columnheader">G</div>';
                                                    htmlInsideTabsConstructorS += '<div title="Points" class="flex-row fix-width" role="columnheader">Pts</div>';
                                                    htmlInsideTabsConstructorS += '</div>';
                                                    htmlInsideTabsConstructorS += '<div class="table__body">';
                                                    $.each(onlySelectedGroup, function (keys, values) {
                                ...
                                $.ajax({
                                    ...
                                    if(!res.error){
                                        if(res.result){
                                            ...
                                            htmlInsideTabsConstructorO += '<div class="flex-table header" role="rowgroup">';
                                            htmlInsideTabsConstructorO += '<div title="Bookmakers" class="flex-row bookmakers" role="columnheader">Bookmakers</div>';
                                            htmlInsideTabsConstructorO += '<div title="Yes" class="flex-row oddWidth" role="columnheader">Oui</div>';
                                            htmlInsideTabsConstructorO += '<div title="No" class="flex-row oddWidth" role="columnheader">Non</div>';
                                            htmlInsideTabsConstructorO += '</div>';
                                            htmlInsideTabsConstructorO += '<div class="table__body">';
                                            var btsyesno = '';
                                            htmlInsideTabsConstructorO += '</div>';
                                        ...
                                        if(res.result) {
                                            ...
                                            $.each(pasianHandicapData, function (key, value) {
                                                if (value != '') {
                                                    pallHandicaps += '<div class="flex-table header" role="rowgroup">';
                                                    pallHandicaps += '<div title="' + key + '" class="flex-row bookmakers" role="columnheader">' + key + '</div>';
                                                    pallHandicaps += '<div title="Home" class="flex-row oddWidth" role="columnheader">Domicile</div>';
                                                    pallHandicaps += '<div title="Away" class="flex-row oddWidth" role="columnheader">Exterieur</div>';
                                                    pallHandicaps += '</div>';
                                                    pallHandicaps += '<div class="table__body">';
                                                    $.each(value, function (keys, values) {
                                                        pallHandicaps += '<div class="flex-table row" role="rowgroup">';
          ...
          if (e.data) {
            var data = JSON.parse(e.data);
              ...
              if (res.result) {
                ...
                if ((res.result[0].event_referee != '') || (res.result[0].event_stadium != '')) {
                    htmlConstructor += '<div>';
                    htmlConstructor += '<div class="matchExtraInfosTitle">Information du match</div>';
                    htmlConstructor += '<div class="matchExtraInfos">' + ((res.result[0].event_referee != '') ? 'Referee: ' + res.result[0].event_referee : '') + ' ' + ((res.result[0].event_stadium != '') ? 'Stadium: ' + res.result[0].event_stadium : '') + '</div>';
                    htmlConstructor += '</div>';
                }
